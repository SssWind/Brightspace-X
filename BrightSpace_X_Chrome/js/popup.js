function initPopup() {
    ...
    chrome.storage.sync.get(getOptionListDefault(), function (items) {
        ...
        $('<div class="btn btn-yellow">' +
            '<div class="btn-icon"><img src="../img/popup-icon-plane.png" alt="Brightspace"></div>' +
            '<div class="btn-text">Open Brightspace</div></div>').on('click', function () {
            chrome.tabs.create({
                url: 'https://' + items.GLB_UserSite + '/d2l/home'
            });
        }).appendTo(quickLinks);
    });
